...
if __name__ == '__main__':
	...
	y_space = []
	"*** YOUR CODE HERE ***"
	X_space = np.linspace(0.0,5.0,num=100).reshape(-1, 1)
	y_space = (b_opt + m_opt*X_space).reshape(-1, 1)
	...
	"*** YOUR CODE HERE ***"
	y_space_rand = b_opt + m_opt*X_space + noise
	"*** END YOUR CODE HERE ***"


	
	"*** YOUR CODE HERE ***"
	onesArray = np.ones_like(y_space)
	X_space_stacked = np.hstack((onesArray, X_space))
